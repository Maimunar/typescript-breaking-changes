...
/*
 * Change Build Type from UnionType  
 */

const promisify = <T>(value: T): Promise<T> => Promise.resolve(value);

// Change Build Type From UnionType - Literal

// Initial Value
const UnionTypeWithLiteral: Defaults["UnionType"]["Literal"] = 1
// Changes
...
// Change Build Type From UnionType - Object

// Initial Value
const UnionTypeWithObject: Defaults["UnionType"]["Object"] = {}
// Changes
...
// Change Build Type From UnionType - String

// Initial Value
const UnionTypeWithString: Defaults["UnionType"]["String"] = "two"
// Changes
...
// Change Build Type From UnionType - Number

// Initial Value
const UnionTypeWithNumber: Defaults["UnionType"]["Number"] = 2
// Changes
...
// Change Build Type From UnionType - Boolean

// Initial Value
const UnionTypeWithBoolean: Defaults["UnionType"]["Boolean"] = true
// Changes
...
// Change Build Type From UnionType - Any

// Initial Value
const UnionTypeWithAny: Defaults["UnionType"]["Any"] = 2
// Changes
