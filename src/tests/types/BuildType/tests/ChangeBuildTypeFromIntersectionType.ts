...
/*
 * Change Build Type from IntersectionType  
 */

const promisify = <T>(value: T): Promise<T> => Promise.resolve(value);

// Change Build Type From IntersectionType - Literal

// Initial Value
const IntersectionTypeWithLiteral: Defaults["IntersectionType"]["Literal"] = 1
// Changes
...
// Change Build Type From IntersectionType - Object

// Initial Value
const IntersectionTypeWithObject: Defaults["IntersectionType"]["Object"] = {}
// Changes
...
// Change Build Type From IntersectionType - String

// Initial Value
const IntersectionTypeWithString: Defaults["IntersectionType"]["String"] = "two"
// Changes
...
// Change Build Type From IntersectionType - Number

// Initial Value
const IntersectionTypeWithNumber: Defaults["IntersectionType"]["Number"] = 2
// Changes
...
// Change Build Type From IntersectionType - Boolean

// Initial Value
const IntersectionTypeWithBoolean: Defaults["IntersectionType"]["Boolean"] = true
// Changes
...
// Change Build Type From IntersectionType - Any

// Initial Value
const IntersectionTypeWithAny: Defaults["IntersectionType"]["Any"] = 2
// Changes
