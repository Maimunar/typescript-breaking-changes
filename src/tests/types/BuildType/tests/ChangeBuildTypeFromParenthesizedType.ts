...
/*
 * Change Build Type from ParenthesizedType  
 */

const promisify = <T>(value: T): Promise<T> => Promise.resolve(value);

// Change Build Type From ParenthesizedType - Literal

// Initial Value
const ParenthesizedTypeWithLiteral: Defaults["ParenthesizedType"]["Literal"] = 1
// Changes
...
// Change Build Type From ParenthesizedType - Object

// Initial Value
const ParenthesizedTypeWithObject: Defaults["ParenthesizedType"]["Object"] = {}
// Changes
...
// Change Build Type From ParenthesizedType - String

// Initial Value
const ParenthesizedTypeWithString: Defaults["ParenthesizedType"]["String"] = "two"
// Changes
...
// Change Build Type From ParenthesizedType - Number

// Initial Value
const ParenthesizedTypeWithNumber: Defaults["ParenthesizedType"]["Number"] = 2
// Changes
...
// Change Build Type From ParenthesizedType - Boolean

// Initial Value
const ParenthesizedTypeWithBoolean: Defaults["ParenthesizedType"]["Boolean"] = true
// Changes
...
// Change Build Type From ParenthesizedType - Any

// Initial Value
const ParenthesizedTypeWithAny: Defaults["ParenthesizedType"]["Any"] = 2
// Changes
