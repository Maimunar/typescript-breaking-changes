...
/*
 * Change Build Type from TypeReferencePredefined  
 */

const promisify = <T>(value: T): Promise<T> => Promise.resolve(value);

// Change Build Type From TypeReferencePredefined - Literal

// Initial Value
const TypeReferencePredefinedWithLiteral: Defaults["TypeReferencePredefined"]["Literal"] = 1
// Changes
...
const TupleTypeWithLiteralToTupleTypeLiteral: Defaults["TupleType"]["Literal"] = 1;
const TupleTypeWithLiteralToTupleTypeObject: Defaults["TupleType"]["Object"] = 1;
const TupleTypeWithLiteralToTupleTypeString: Defaults["TupleType"]["String"] = 1;
const TupleTypeWithLiteralToTupleTypeNumber: Defaults["TupleType"]["Number"] = 1;
const TupleTypeWithLiteralToTupleTypeBoolean: Defaults["TupleType"]["Boolean"] = 1;
const TupleTypeWithLiteralToTupleTypeAny: Defaults["TupleType"]["Any"] = 1;
...
// Change Build Type From TypeReferencePredefined - Object

// Initial Value
const TypeReferencePredefinedWithObject: Defaults["TypeReferencePredefined"]["Object"] = {}
// Changes
...
// Change Build Type From TypeReferencePredefined - String

// Initial Value
const TypeReferencePredefinedWithString: Defaults["TypeReferencePredefined"]["String"] = "two"
// Changes
...
const TupleTypeWithStringToTupleTypeLiteral: Defaults["TupleType"]["Literal"] = "two";
const TupleTypeWithStringToTupleTypeObject: Defaults["TupleType"]["Object"] = "two";
const TupleTypeWithStringToTupleTypeString: Defaults["TupleType"]["String"] = "two";
const TupleTypeWithStringToTupleTypeNumber: Defaults["TupleType"]["Number"] = "two";
const TupleTypeWithStringToTupleTypeBoolean: Defaults["TupleType"]["Boolean"] = "two";
const TupleTypeWithStringToTupleTypeAny: Defaults["TupleType"]["Any"] = "two";
...
// Change Build Type From TypeReferencePredefined - Number

// Initial Value
const TypeReferencePredefinedWithNumber: Defaults["TypeReferencePredefined"]["Number"] = 2
// Changes
...
const TupleTypeWithNumberToTupleTypeLiteral: Defaults["TupleType"]["Literal"] = 2;
const TupleTypeWithNumberToTupleTypeObject: Defaults["TupleType"]["Object"] = 2;
const TupleTypeWithNumberToTupleTypeString: Defaults["TupleType"]["String"] = 2;
const TupleTypeWithNumberToTupleTypeNumber: Defaults["TupleType"]["Number"] = 2;
const TupleTypeWithNumberToTupleTypeBoolean: Defaults["TupleType"]["Boolean"] = 2;
const TupleTypeWithNumberToTupleTypeAny: Defaults["TupleType"]["Any"] = 2;
...
// Change Build Type From TypeReferencePredefined - Boolean

// Initial Value
const TypeReferencePredefinedWithBoolean: Defaults["TypeReferencePredefined"]["Boolean"] = true
// Changes
...
const TupleTypeWithBooleanToTupleTypeLiteral: Defaults["TupleType"]["Literal"] = true;
const TupleTypeWithBooleanToTupleTypeObject: Defaults["TupleType"]["Object"] = true;
const TupleTypeWithBooleanToTupleTypeString: Defaults["TupleType"]["String"] = true;
const TupleTypeWithBooleanToTupleTypeNumber: Defaults["TupleType"]["Number"] = true;
const TupleTypeWithBooleanToTupleTypeBoolean: Defaults["TupleType"]["Boolean"] = true;
const TupleTypeWithBooleanToTupleTypeAny: Defaults["TupleType"]["Any"] = true;
...
// Change Build Type From TypeReferencePredefined - Any

// Initial Value
const TypeReferencePredefinedWithAny: Defaults["TypeReferencePredefined"]["Any"] = 2
// Changes
...
// TupleType With Any
const TupleTypeWithAnyToTupleTypeLiteral: Defaults["TupleType"]["Literal"] = 2;
const TupleTypeWithAnyToTupleTypeObject: Defaults["TupleType"]["Object"] = 2;
const TupleTypeWithAnyToTupleTypeString: Defaults["TupleType"]["String"] = 2;
const TupleTypeWithAnyToTupleTypeNumber: Defaults["TupleType"]["Number"] = 2;
const TupleTypeWithAnyToTupleTypeBoolean: Defaults["TupleType"]["Boolean"] = 2;
const TupleTypeWithAnyToTupleTypeAny: Defaults["TupleType"]["Any"] = 2;
// ArrayType With Any
