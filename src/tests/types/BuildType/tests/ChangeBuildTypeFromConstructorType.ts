...
/*
 * Change Build Type from ConstructorType  
 */

const promisify = <T>(value: T): Promise<T> => Promise.resolve(value);

// Change Build Type From ConstructorType - Literal

// Initial Value
const ConstructorTypeWithLiteral: Defaults["ConstructorType"]["Literal"] = 1
// Changes
...
// Change Build Type From ConstructorType - Object

// Initial Value
const ConstructorTypeWithObject: Defaults["ConstructorType"]["Object"] = {}
// Changes
...
// Change Build Type From ConstructorType - String

// Initial Value
const ConstructorTypeWithString: Defaults["ConstructorType"]["String"] = "two"
// Changes
...
// Change Build Type From ConstructorType - Number

// Initial Value
const ConstructorTypeWithNumber: Defaults["ConstructorType"]["Number"] = 2
// Changes
...
// Change Build Type From ConstructorType - Boolean

// Initial Value
const ConstructorTypeWithBoolean: Defaults["ConstructorType"]["Boolean"] = true
// Changes
...
// Change Build Type From ConstructorType - Any

// Initial Value
const ConstructorTypeWithAny: Defaults["ConstructorType"]["Any"] = 2
// Changes
