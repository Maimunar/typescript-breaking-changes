...
export const defaults: Defaults = {
  ParenthesizedType: {
    Literal: { [Symbol("symbolKey")]: 1 },
    Object: { [Symbol("symbolKey")]: {} },
    String: { [Symbol("symbolKey")]: "two" },
    Number: { [Symbol("symbolKey")]: 2 },
    Boolean: { [Symbol("symbolKey")]: true },
    Any: { [Symbol("symbolKey")]: 2 },
  },
  TypeReferenceBuiltin: {
    Literal: { [Symbol("symbolKey")]: promisify(1) },
    Object: { [Symbol("symbolKey")]: promisify({}) },
    String: { [Symbol("symbolKey")]: promisify("two") },
    Number: { [Symbol("symbolKey")]: promisify(2) },
    Boolean: { [Symbol("symbolKey")]: promisify(true) },
    Any: { [Symbol("symbolKey")]: promisify(2) },
  },
  TypeReferencePredefined: {
    Literal: { [Symbol("symbolKey")]: 1 },
    Object: { [Symbol("symbolKey")]: {} },
  ...
  TypeLiteral: {
    Literal: { [Symbol("symbolKey")]: { key: 1 } },
    Object: { [Symbol("symbolKey")]: { key: {} } },
    String: { [Symbol("symbolKey")]: { key: "two" } },
    Number: { [Symbol("symbolKey")]: { key: 2 } },
    Boolean: { [Symbol("symbolKey")]: { key: true } },
    Any: { [Symbol("symbolKey")]: { key: 2 } },
  },
  TupleType: {
    Literal: { [Symbol("symbolKey")]: [1] },
    Object: { [Symbol("symbolKey")]: [{}] },
  ...
  ArrayType: {
    Literal: { [Symbol("symbolKey")]: [1, 1] },
    Object: { [Symbol("symbolKey")]: [{}, {}] },
    String: { [Symbol("symbolKey")]: ["two", "two"] },
    Number: { [Symbol("symbolKey")]: [2, 2] },
    Boolean: { [Symbol("symbolKey")]: [true, true] },
    Any: { [Symbol("symbolKey")]: [2, 2] },
  },
  FunctionType: {
    Literal: { [Symbol("symbolKey")]: (param: 1) => {} },
    Object: { [Symbol("symbolKey")]: (param: object) => {} },
    String: { [Symbol("symbolKey")]: (param: string) => {} },
    Number: { [Symbol("symbolKey")]: (param: number) => {} },
    Boolean: { [Symbol("symbolKey")]: (param: boolean) => {} },
    Any: { [Symbol("symbolKey")]: (param: any) => {} },
  },
  ConstructorType: {
    Literal: { [Symbol("symbolKey")]: 1 },
    Object: { [Symbol("symbolKey")]: {} },
